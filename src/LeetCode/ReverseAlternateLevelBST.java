...
class ReverseAlternateLevelBST {

    TNode root;
    Index index_obj = new Index();

    // function to store alternate levels in a tree
    void storeAlternate(TNode node, char arr[], Index index, int l) {
        // base case
        if (node == null) {
            return;
        }
    ...
    void modifyTree(TNode node, char arr[], Index index, int l) {
    ...
    void reverseAlternate(TNode node) {
    ...
    public static void main(String args[]) {
        ReverseAlternateLevelBST tree = new ReverseAlternateLevelBST();
